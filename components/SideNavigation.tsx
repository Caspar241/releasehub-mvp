...
export default function SideNavigation({
  ...
  return (
    <>
      ...
      {/* Side Panel */}
      <aside
        className="fixed top-0 right-0 bottom-0 w-full sm:w-96 bg-surface-raised/98 backdrop-blur-glass border-l border-border z-[70] overflow-y-auto transition-transform duration-300"
      >
        <div className="p-6">
          {/* Header */}
